...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 99155 68071.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Realty Options · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="Aerocity Mohali · SAS Nagar · Punjab · 140307" />
              ...
              <a href="tel:+919915568071" className="bm-call">Or call the desk · +91 99155 68071</a>
            </aside>
          </form>
        )}
      </div>
